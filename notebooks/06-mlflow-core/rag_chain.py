# rag_chain.py — the Module 05 RAG chain, self-contained (no notebook globals). Loading re-runs this file.
import mlflow
...
mlflow.langchain.autolog()   # loaded/served copies keep emitting traces
