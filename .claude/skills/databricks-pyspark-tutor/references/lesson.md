<!--
================================================================================
CANONICAL WORKED EXEMPLAR — DBX PySpark Performance track  (lesson.md)
================================================================================
This is the GOLD-STANDARD example the databricks-pyspark-tutor skill mirrors to
author EVERY lesson's `lesson.md`. It is a complete, real lesson (Lesson 02 —
Joins), not a skeleton: copy its DEPTH, SECTION ORDER, code+verification pattern,
analogy/use-case chips, comparison table, uses/edge/limits block, gotchas, mermaid
diagram, and References. For another topic, keep the structure and swap the content
(re-verify every number against references/fact-sheet.md + the live docs).

In a real lesson folder this file is named `lesson.md` and sits beside `index.html`
(the interactive HTML, mirror of references/lesson.html) and the `.py` notebook.
Strip this comment block from the actual lesson file.
================================================================================
-->
